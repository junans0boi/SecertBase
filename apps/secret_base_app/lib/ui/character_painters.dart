...
class CharacterBust extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      width: width,
      height: height,
      child: CustomPaint(painter: CharacterBustPainter(character: character)),
    );
  }
}
...
class CharacterBustPainter extends CustomPainter {
  ...
  void _drawHairBack(
    ...
    switch (char.hairStyle) {
      case 'bob':
        ...
        canvas.drawOval(
          Rect.fromCenter(
            center: faceCenter.translate(0, faceR * 0.15),
            width: faceR * 2.55,
            height: faceR * 2.6,
          ),
          hair,
      ...
      case 'long':
        ...
        final path = Path()
          ...
          ..quadraticBezierTo(
            ...
            size.height,
            cx + faceR * 1.25,
            faceCenter.dy - faceR * 0.8,
          )
          ..close();
        canvas.drawPath(path, hair);
        canvas.drawOval(
          Rect.fromCenter(
            center: faceCenter.translate(0, -faceR * 0.05),
            width: faceR * 2.55,
            height: faceR * 2.5,
          ),
          hair,
      ...
      case 'silver':
        ...
        canvas.drawOval(
          Rect.fromCenter(
            center: faceCenter.translate(0, -faceR * 0.12),
            width: faceR * 2.45,
            height: faceR * 2.4,
          ),
          hair,
      ...
      default: // short, medium
        canvas.drawOval(
          Rect.fromCenter(
            center: faceCenter.translate(0, -faceR * 0.08),
            width: faceR * 2.4,
            height: faceR * 2.3,
          ),
          hair,
  ...
  void _drawFace(Canvas canvas, Size size, double cx, MarbleCharacter char) {
    ...
    canvas.drawCircle(
      Offset(cx - faceR * 0.55, faceCenter.dy + faceR * 0.22),
      faceR * 0.27,
      blushPaint,
    );
    canvas.drawCircle(
    ...
    switch (char.hairStyle) {
      case 'bob':
        ...
        canvas.clipRect(
          Rect.fromLTRB(
            ...
            0,
            cx + faceR * 1.3,
            faceCenter.dy - faceR * 0.6,
          ),
        );
        canvas.drawOval(
          Rect.fromCenter(
            center: faceCenter.translate(0, -faceR * 0.6),
            width: faceR * 2.55,
            height: faceR * 1.3,
          ),
          hair,
      ...
      case 'long':
        ...
        final bangPath = Path()
          ...
          ..quadraticBezierTo(
            cx - faceR * 0.2,
            faceCenter.dy - faceR * 0.5,
            cx + faceR * 0.5,
            faceCenter.dy - faceR * 0.7,
          )
          ..quadraticBezierTo(
            cx + faceR * 1.1,
            faceCenter.dy - faceR * 1.0,
            cx + faceR * 1.0,
            faceCenter.dy - faceR * 1.2,
          )
          ..close();
      ...
      case 'spiky':
        ...
        for (int i = 0; i < spikeCount; i++) {
          ...
          final sp = Paint()
            ..color = i == 2 ? const Color(0xFF3B82F6) : char.hairColor;
          canvas.drawPath(
            Path()
      ...
      default: // short/medium
        // 라운드 앞머리
        final bangClip = Rect.fromLTRB(
          cx - faceR * 1.2,
          0,
          cx + faceR * 1.2,
          faceCenter.dy - faceR * 0.55,
        );
        canvas.save();
        canvas.clipRect(bangClip);
        canvas.drawOval(
          Rect.fromCenter(
            center: faceCenter.translate(0, -faceR * 0.7),
            width: faceR * 2.35,
            height: faceR * 1.2,
          ),
          hair,
  ...
  void _drawEyes(Canvas canvas, Size size, double cx, MarbleCharacter char) {
    ...
    canvas.drawOval(
      Rect.fromCenter(
        center: Offset(cx - faceR * 0.36, faceCenter.dy - faceR * 0.07),
        width: faceR * 0.38,
        height: faceR * 0.28,
      ),
      eyeWhite,
  ...
  void _drawSpecial(Canvas canvas, Size size, double cx, MarbleCharacter char) {
    ...
    switch (char.special) {
      ...
      case 'goggles':
        ...
        canvas.drawOval(
          Rect.fromCenter(
            center: Offset(cx - faceR * 0.35, goggleY),
            width: faceR * 0.5,
            height: faceR * 0.3,
          ),
      ...
      case 'anchor':
        ...
        canvas.drawLine(
          Offset(ac.dx, ac.dy - 5),
          Offset(ac.dx, ac.dy + 5),
          anchorPaint,
        );
        canvas.drawLine(
          Offset(ac.dx - 4, ac.dy + 3),
          Offset(ac.dx + 4, ac.dy + 3),
          anchorPaint,
        );
    }
  ...
  void _drawTie(
    ...
    canvas.drawLine(
      ...
      Offset(cx, bodyY + 15),
      Paint()
        ..color = _darken(tieColor, 0.2)
        ..strokeWidth = 1,
    );
  }

  // ── 등급 배지 ────────────────────────────────────────────────────────────
  void _drawGradeBadge(
    Canvas canvas,
    Size size,
    double cx,
    MarbleCharacter char,
    ...
    canvas.drawCircle(badgeCenter, 8, Paint()..color = gradeColor);
    canvas.drawCircle(
      badgeCenter,
      8,
      Paint()
  ...
  void _drawOmega(Canvas canvas, Size size, double cx, MarbleCharacter char) {
    ...
    canvas.drawOval(
      Rect.fromCenter(
        center: Offset(cx - faceR * 0.3, faceCenter.dy - faceR * 0.1),
        width: faceR * 0.38,
        height: faceR * 0.2,
      ),
      glowPaint,
